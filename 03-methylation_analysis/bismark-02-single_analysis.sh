...
for r in $(ls $READS_LOCATION*$EXT)
  do
    ...
    $BISMARK_LOCATION/bismark $GENOME_DIRECTORY $read1 --path_to_bowtie2 $BOWTIE_LOCATION --samtools_path $SAMTOOLS_LOCATION
...
# Alternate command used: ./bismark-02-single_analysis.sh -g /home/tofumeow/Documents/UPLB/Y3SM/reference-genome/Gasterosteus_aculeatus -r /home/tofumeow/Documents/UPLB/Y3SM/stickleback-methylation/02-quality_control/fastp_bin_single/ -e .cleaned.fastq